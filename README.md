...
Keonsang - I really liked your point that a clean merge doesn't mean working software.
Git only compares text, so automated tests are what actually catch the problem.
Keeping changes small seems like the answer to your question too, since small
changes are both easier to integrate and faster to review.